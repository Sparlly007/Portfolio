        ...
        <section>
            <div class="container">
                ...
                <div class="align-left gray-text">
                    ...
                    {/* <p>I've coded ever since high school and learned different programming languages and technologies
                        that increased my interest in learning new ways of problem-solving.</p> */}
            ...
            {/* <div class="text-center">
                Skillset: Java, C#, Python, Vue, React, Spring Boot, Postgres, Bootstrap, Git, R, Docker, DigitalOcean
            </div> */}
        </section>
    );
};
